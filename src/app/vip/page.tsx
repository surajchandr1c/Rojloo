  ...
  return (
    <main className="p-4 sm:p-6 lg:p-10 min-w-0">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black text-gray-950">VIP Dashboard</h1>
          <p className="mt-2 text-gray-900">
            Welcome, <span className="font-semibold">{me.email}</span>. Here is the overview of your assigned jurisdiction.
          </p>
        </div>
        <div className="inline-flex items-center rounded-full bg-gray-100 px-3.5 py-1.5 text-xs font-bold text-gray-900 border border-gray-200">
          <span className="mr-1.5 inline-block h-2 w-2 rounded-full bg-gray-500 animate-pulse" />
          VIP Control Active
        </div>
      </div>
      ...
      <div className="mt-8 grid grid-cols-2 gap-4 sm:grid-cols-4">
        {statCards.map((card) => {
          const cardContent = (
            <div className="rounded-2xl border border-gray-200 bg-white p-4 sm:p-5 transition-all hover:border-gray-300 hover:shadow-sm">
              <span className="text-xs font-semibold text-gray-800 uppercase tracking-wider">
                {card.label}
              </span>
              <div className="mt-2 text-3xl font-black text-gray-950">
      ...
      <div className="mt-8 rounded-2xl border border-gray-200 bg-white p-5 sm:p-6">
        <h2 className="text-lg font-bold text-gray-950">Your Assigned Access</h2>
