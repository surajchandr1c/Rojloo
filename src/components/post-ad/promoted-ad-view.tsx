    ...
    <main className="px-2.5 py-6 sm:px-6 sm:py-10 lg:px-8 max-w-full overflow-hidden">
      <SectionPanel className="p-3.5 sm:p-6 md:p-8 w-full max-w-5xl mx-auto overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 border-b border-gray-100 pb-4">
          <div>
            <div className="flex flex-wrap items-center gap-2">
              <h1 className="text-2xl sm:text-3xl md:text-4xl font-black text-gray-950">
                Promote The Ad
              </h1>
              <span className="rounded-full bg-gray-100 px-2.5 py-0.5 text-xs font-black text-gray-900 uppercase">
        ...
        {searchParams.get("required") === "1" && (
          <div className="mt-4 rounded-2xl border border-gray-300 bg-gray-50 p-4 text-xs sm:text-sm font-semibold text-gray-950 flex items-start gap-3 shadow-xs">
            <span className="text-xl shrink-0 mt-0.5">⚠️</span>
            <div>
              <p className="font-bold text-sm sm:text-base text-gray-950">
                Promotion Required to Publish on City Page
              </p>
              <p className="text-xs sm:text-sm text-gray-900 mt-0.5 leading-relaxed font-medium">
        ...
        {/* Notifications */}
        {successMessage && (
          <div className="mt-4 rounded-xl border border-gray-300 bg-gray-50 p-3.5 text-xs sm:text-sm font-semibold text-gray-900">
            {successMessage}
          </div>
        )}

        {errorMessage && (
          <div className="mt-4 rounded-xl border border-gray-300 bg-gray-50 p-3.5 text-xs sm:text-sm font-semibold text-gray-900 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            <span>{errorMessage}</span>
            {!hasEnoughCoins && (
              <Link
                href="/post-ad/buy-coin"
                className="underline font-bold text-gray-700 hover:text-gray-950"
              >
                Buy Coins Now &rarr;
              </Link>
            )}
        ...
        <div className="mt-6 rounded-2xl bg-white border border-gray-200/90 p-4 sm:p-6 shadow-xs">
          <h2 className="text-sm sm:text-base font-black text-gray-950 uppercase tracking-wide">
          ...
          {loading ? (
            ...
            <div className="mt-3 rounded-xl bg-gray-50/60 p-4 text-center">
            ...
            <div className="mt-3">
              <div className="max-w-md">
                ...
                <select
                  ...
                  className="w-full rounded-xl border border-gray-200 bg-gray-50/30 p-2.5 text-xs sm:text-sm font-medium text-gray-950 focus:border-gray-600 focus:outline-none"
                >
                  {ads.map((ad) => (
              ...
              {selectedAd && (
                <div className="mt-4 rounded-xl border border-gray-100 bg-gray-50/25 p-3 sm:p-4 flex flex-col sm:flex-row gap-3.5 sm:gap-4 overflow-hidden">
                  <div className="relative shrink-0 w-full sm:w-36 h-40 sm:h-28 rounded-xl overflow-hidden bg-gray-100 flex items-center justify-center border border-gray-200/60">
                    {selectedAd.images?.[0] ? (
                      <Image
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        {isAdPromoted(selectedAd) ? (
                          <span className="rounded-full bg-gray-100 border border-gray-300 px-2 py-0.5 text-[10px] font-bold text-gray-800">
                            ⭐ Already Promoted
                          </span>
                        ) : (
                          <span className="rounded-full bg-gray-100 border border-gray-300 px-2 py-0.5 text-[10px] font-bold text-gray-800">
                      ...
                      <h3 className="mt-1 text-sm sm:text-base font-black text-gray-600 truncate">
        ...
        <div className="mt-6 rounded-2xl bg-white border border-gray-200/90 p-4 sm:p-6 shadow-xs">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 border-b border-gray-100 pb-3">
            <div>
              <div className="flex items-center gap-2">
                ...
                {allShifts && (
                  <span className="rounded-full bg-gray-100 border border-gray-300 px-2 py-0.5 text-[10px] font-black text-gray-900 uppercase tracking-wider">
            ...
            <div className="flex items-center gap-3 self-start md:self-auto bg-gray-50/80 border border-gray-200/80 rounded-2xl px-3.5 py-2">
              <div className="text-left">
                <div className="text-xs font-black text-gray-950 flex items-center gap-1.5">
                  <span>All Time Slots</span>
                  <span className="rounded-md bg-gray-100 px-1.5 py-0.5 text-[9px] font-bold text-gray-800 uppercase">
                    24 Hours
                  </span>
                </div>
              </div>
              ...
              return (
                <div
                  ...
                  className={`relative cursor-pointer rounded-2xl p-4 text-center transition-all select-none border ${
                    allShifts
                      ? "border-gray-500 bg-gray-50/60 shadow-xs ring-2 ring-gray-500/20"
                      : isSelected
                      ? "border-gray-600 bg-gray-50 shadow-md ring-2 ring-gray-500/30 scale-[1.01]"
                      : "border-gray-200/80 bg-white hover:border-gray-300 hover:bg-gray-50/20"
                  }`}
                >
                  ...
                  {isBoxActiveNow && (
                    <span className="mt-2 inline-block rounded-full bg-gray-100 px-2 py-0.5 text-[10px] font-bold text-gray-800">
                      Live Now
                    </span>
                  )}
                </div>
          ...
          {isShiftSelected && (
            <div className="mt-4 rounded-xl border border-gray-100 bg-gray-50/40 p-3 text-xs font-semibold">
              {allShifts ? (
                <p className="text-gray-900 leading-relaxed">
                  ...
                  <strong className="underline text-gray-950">{formatDateTime(currentShiftTiming.promotedUntil)}</strong>.
                </p>
                ...
                <p className="text-gray-900 leading-relaxed">
                  ...
                  <strong className="underline text-gray-950">{formatDateTime(currentShiftTiming.promotedFrom)}</strong> and run during the{" "}
                  <strong>{getShiftShortLabel(selectedShift || "morning")}</strong> shift until{" "}
                  <strong className="underline text-gray-950">{formatDateTime(currentShiftTiming.promotedUntil)}</strong>.
                </p>
              ) : (
                <p className="text-gray-900 leading-relaxed">
                  ...
                  <strong className="underline text-gray-950">{formatDateTime(currentShiftTiming.promotedFrom)}</strong> and runs during the{" "}
                  <strong>{getShiftShortLabel(selectedShift || "morning")}</strong> shift until{" "}
                  <strong className="underline text-gray-950">{formatDateTime(currentShiftTiming.promotedUntil)}</strong>.
                </p>
              )}
        ...
        {isShiftSelected && (
          <div className="mt-6 rounded-2xl bg-white border border-gray-200/90 p-4 sm:p-6 shadow-xs animate-in fade-in slide-in-from-top-2 duration-300">
            <div className="border-b border-gray-100 pb-3 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
              <div>
                <h2 className="text-sm sm:text-base font-black text-gray-950 uppercase tracking-wide flex items-center gap-2">
                  <span>3. Choose a Promotion Package</span>
                  {allPackages && (
                    <span className="rounded-full bg-gray-100 border border-gray-300 px-2 py-0.5 text-[10px] font-black text-gray-900 uppercase">
                      👑 All-in-One Combo
                    </span>
                  )}
                </h2>
              ...
              <div className="flex items-center gap-3 self-start md:self-auto bg-gray-50/80 border border-gray-200 rounded-2xl px-3.5 py-2">
                <div className="text-left">
                  <div className="text-xs font-black text-gray-950 flex items-center gap-1.5">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                    allPackages ? "bg-gray-600" : "bg-gray-300"
                  }`}
                >
                  <span
                    aria-hidden="true"
            ...
            {allPackages ? (
              <div className="mt-5 rounded-2xl border-2 border-gray-400 bg-gradient-to-br from-gray-50/90 via-gray-50/40 to-gray-50/80 p-5 sm:p-6 shadow-md relative overflow-hidden">
                <div className="absolute -right-6 -top-6 w-28 h-28 bg-gray-300/20 rounded-full blur-xl pointer-events-none" />

                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                  <div>
                    <div className="inline-flex items-center gap-1.5 rounded-full bg-gray-200/90 border border-gray-400 px-3 py-0.5 text-xs font-black text-gray-950 uppercase tracking-wider">
                      <span>👑 ALL-IN-ONE VIP COMBO</span>
                    </div>
                    <h3 className="mt-2 text-lg sm:text-xl font-black text-gray-950">
                  ...
                  <div className="shrink-0 bg-white/90 border border-gray-300 rounded-2xl p-3.5 sm:text-right shadow-xs">
                ...
                <div className="mt-4 pt-4 border-t border-gray-200/80 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 text-xs font-bold text-gray-800">
                  <div className="flex items-center gap-2 bg-white/70 rounded-xl p-2.5 border border-gray-200/60">
                  ...
                  return (
                    <div
                      ...
                      className={`relative cursor-pointer rounded-2xl p-4 transition-all flex flex-col justify-between border ${
                        isSelected
                          ? "border-gray-600 bg-gray-50/90 shadow-md ring-2 ring-gray-500/20 scale-[1.01]"
                          : "border-gray-100 bg-white hover:border-gray-300 hover:bg-gray-50/30"
                      }`}
                    >
                      {/* Badge */}
                      {pkg.tag && (
                      ...
                      <div>
                        ...
                        <h3 className="text-xs sm:text-sm font-black text-gray-950 pr-4">
                          {pkg.title}
                        </h3>

                        {/* Guaranteed Position Pill */}
                        <div className="mt-2 inline-flex items-center gap-1 rounded-lg bg-gray-100/80 px-2 py-0.5 text-[11px] font-extrabold text-gray-950">
                          <span>🎯 Position:</span>
                          <span className="text-gray-700 underline">{pkg.rankRange || tierInfo.rankRange}</span>
                        </div>
                        ...
                        <div className="mt-3">
                          <div className="flex items-baseline gap-1.5">
                            ...
                            <span className="text-xs font-bold text-gray-600">Coins</span>
                            <span className="rounded-md bg-gray-100 px-1.5 py-0.5 text-[10px] font-black text-gray-900 uppercase">
            ...
            <div className="mt-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 rounded-xl bg-gray-50/50 border border-gray-200/80 p-4">
              <div>
                <p className="text-[11px] uppercase tracking-wider text-gray-500 font-black">
                  Promotion Summary &bull; Calculated Total
                </p>
                <div className="text-sm font-black text-gray-950 mt-0.5 flex flex-wrap items-center gap-1.5">
                  <span>{allPackages ? "👑 All Packages VIP Combo" : selectedPkg.title}</span>
                  <span className="text-gray-400">&bull;</span>
                  <span className="text-gray-700 font-black text-base">{totalCoinsCost} Coins</span>
                  <span className="text-xs text-gray-600 font-bold">
                    ({allShifts ? `${baseCoins} coins × 4 shifts (24h)` : `${totalCoinsCost} coins / 1 shift`})
                  </span>
                </div>
                <p className="text-xs text-gray-600 font-medium mt-0.5">
                  Slot: <strong className="text-gray-950">{allShifts ? "All 4 Shifts (24 Hours Full Day)" : getShiftLabel(selectedShift || "morning")}</strong>
                </p>
              </div>
      ...
      {modalData && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4 animate-modal-backdrop">
          <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-2xl border border-gray-200 text-center relative animate-modal-content">
            ...
            <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-gray-100 text-3xl">
              🎉
            </div>
            ...
            <p className="mt-1 text-xs font-semibold text-gray-600 truncate max-w-xs mx-auto">
              {modalData.adTitle} &bull; <span className="text-gray-700 font-bold">{modalData.rankRange}</span>
            </p>

            {/* Expiry & Time Left Box */}
            <div className="mt-4 rounded-xl border border-gray-100 bg-gray-50/50 p-4 space-y-2.5 text-left">
              <div>
                <p className="text-[10px] font-black uppercase tracking-wider text-gray-500">
                  Promotion Cost Paid:
                </p>
                <p className="text-xs font-bold text-gray-950 mt-0.5">
                  <span className="text-gray-700 font-extrabold text-sm">{modalData.totalCoins || totalCoinsCost} Coins Paid</span>
